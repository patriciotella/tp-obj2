...
public class Prestamo {
	...
	/**
	 * Cambia el estado del pr�stamo a EnCurso, crea las cuotas y aplica la configuraci�n general correspondiente.
	 */
	...
	/**
	 * Cambia el estado del pr�stamo a EnCurso.
	 */
	...
	/**
	 * Cambia el estado del pr�stamo a Rechazado.
	 */
	...
	/**
	 * Chequea si el pr�stamo posee cuotas en deuda; de ser as�,
	...
	/**
	 * Retorna la configuraci�n general correspondiente al pr�stamo.
	 */
	...
	/**
	 * Retorna las cuotas correspondientes al pr�stamo.
	 */
	...
	/**
	 * Retorna el n�mero de cuota que corresponde pagar.
	 */
	...
	/**
	 * Retorna el estado correspondiente al pr�stamo.
	 */
	...
	/**
	 * Retorna el monto correspondiente al pr�stamo.
	 */
	...
	/**
	 * Retorna la fecha en la que se inicio el pr�stamo.
	 */
	...
	/**
	 * Retorna el cliente correspondiente al pr�stamo.
	 */
	...
	/**
	 * Retorna la Cuota a pagar, comparando el id de cuota que posee el pr�stamo con el de las cuotas incluidas en su lista.
	 */
	...
	/**
	 * Retorna true si alguna de las cuotas que posee el pr�stamo est� vencida.
	 */
	...
	/**
	 * Aplica la configuraci�n general (valor mensual, valor global y TEM) a las cuotas y al monto. 
	 */
	...
	/**
	 * Setea la fecha en la que se inicia el pr�stamo.
	 */
